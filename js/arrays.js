...
// split; превращает элементы в массив (делит на массив элементов);
// join; обратная операция, на основании массива делим большую строку; (объединяет элементы массива)
// sort; метод сортировки; сортирует как строки, поэтому при работе с цифровыми данными используем callback функцию.
// псевдоклассы - объект, структура которого совпадает со структурой массива, но он НЕ имеет никаких методов (forEach, filter, etc); Это лишь структура, которая хранит данные по порядку;
